...
/* harmony import */ var _auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./auth/auth.guard */ 1946);
...
const routes = [
    ...
    {
        path: 'auth',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_auth_auth_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./auth/auth.module */ 5036)).then((m) => m.AuthPageModule),
    },
    {
        path: 'places',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_places_places_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./places/places.module */ 1629)).then((m) => m.PlacesPageModule),
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__.AuthGuard]
    },
    {
        path: 'bookings',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_bookings_bookings_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./bookings/bookings.module */ 1204)).then((m) => m.BookingsPageModule),
        canLoad: [_auth_auth_guard__WEBPACK_IMPORTED_MODULE_0__.AuthGuard]
        // These routes are protected and so are their child components
    },
];
...
/* harmony import */ var _C_Users_Njabulo_Majenje_Documents_Code_AirBnB_App_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./app.component.html */ 5158);
...
/* harmony import */ var _capacitor_splash_screen__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @capacitor/splash-screen */ 7567);
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @capacitor/core */ 2960);
...
let AppComponent = class AppComponent {
    constructor(authServ, router, platform) {
...
AppComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-root',
        template: _C_Users_Njabulo_Majenje_Documents_Code_AirBnB_App_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
...
let AuthService = class AuthService {
    ...
    signOut() { this.userAuthenticated = false; }
};
...
const environment = {
    production: false,
    MAPBOX_DOWNLOADS_TOKEN: 'pk.eyJ1IjoiY2hvd2QzciIsImEiOiJja3liZmE3Z3kwZXg0MnVyaW45YjF1dW93In0.gla_gEHHSGieWWiH3xRpWw'
};
/*
