...
/* harmony export */ });
/* harmony import */ var C_Users_Njabulo_Majenje_Documents_GitHub_Code_DOTNET_BookingApp_BookingApp_fit_g_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 4475);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Njabulo_Majenje_Documents_GitHub_Code_DOTNET_BookingApp_BookingApp_fit_g_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    if (delegate) {
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_Njabulo_Majenje_Documents_GitHub_Code_DOTNET_BookingApp_BookingApp_fit_g_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,C_Users_Njabulo_Majenje_Documents_GitHub_Code_DOTNET_BookingApp_BookingApp_fit_g_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
...
/***/ 5736:
/*!***********************************************!*\
  !*** ./src/app/services/live-feed.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LiveFeedService": () => (/* binding */ LiveFeedService)
/* harmony export */ });
...
let LiveFeedService = class LiveFeedService {
    constructor(http) {
        this.http = http;
        this.liveFeedUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.liveFeedUrl;
    }
    getBasketBallFixtures() {
        return this.http.get(this.liveFeedUrl +
            `basketball/?met=Fixtures&APIkey=${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.liveFeedAPI_Key}!&from=2022-03-12&to=2022-03-28`);
    }
    getSupportedCountries(sport) {
        return this.http.get(this.liveFeedUrl +
            `${sport}/?met=Countries&APIkey=${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.liveFeedAPI_Key}`);
    }
    // Retrieves fixtures based on the selected Sport and Country
    // Uses a week advance
    getFixtures(selection) {
        const from = new Date().toISOString().slice(0, 10);
        const toDate = new Date();
        const to = new Date(toDate.setDate(toDate.getDate() + 7)).toISOString().slice(0, 10);
        return this.http.get(this.liveFeedUrl +
            `${selection.sportName.toLowerCase()}/?met=Fixtures&APIkey=${_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.liveFeedAPI_Key}&from=${from}&to=${to}}`);
    }
};
LiveFeedService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
LiveFeedService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
module.exports = "#container {\n  text-align: center;\n  position: absolute;\n  left: 0;\n  right: 0;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n#container strong {\n  font-size: 20px;\n  line-height: 26px;\n}\n\n#container p {\n  font-size: 16px;\n  line-height: 22px;\n  color: #8c8c8c;\n  margin: 0;\n}\n\n#container a {\n  text-decoration: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
